 ...
 *
 * Enhanced theme toggle with smooth transitions and improved visual feedback.
 * Provides seamless switching between light and dark modes with neural network theming.
 */
export function ModeToggle() {
  ...
  return (
    <Button
      ...
      className="hover:bg-accent/20 transition-all duration-300 hover:scale-102"
